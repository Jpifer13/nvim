...
local function lines()
  return {
    ...
    "  │ gi         Implementation      │  │ <Space>e   File tree          │  │ <Space>gn  AI create branch   │",
    "  │ gr         References          │  │ <Space>ff  Find files         │  │ <Space>gc  AI commit          │",
    "  │ K          Hover docs          │  │ <Space>fg  Live grep          │  │ <Space>gb  Toggle blame       │",
    "  │ <Space>rn  Rename              │  │ <Space>fb  Buffers            │  │ <Space>gh  Preview hunk       │",
    "  │ <Space>ca  Code actions        │  │ <Space>?   Cheat sheet        │  │ <Space>gr  Reset hunk         │",
    "  │ <Space>f   Format              │  │ <Space>z   Zen mode           │  │ <Space>go  Open diff          │",
    "  │ ]d/[d      Next/Prev error     │  │ <Space>ta  Toggle autosave    │  │ <Space>gf  File history       │",
    "  └────────────────────────────────┘  │                                │  │ Conflicts (in Diffview):      │",
    "                                      │ Telescope: in file picker      │  │ <Space>co  Accept ours        │",
    "                                      │ Enter      Open in buffer      │  │ <Space>ct  Accept theirs      │",
    "                                      │ Ctrl+v     Open vertical split │  │ <Space>cO  ALL ours (file)    │",
    "                                      │ Ctrl+x     Open horiz split    │  │ <Space>cT  ALL theirs (file)  │",
    ...
    "  │ <Space>k/j Move line up/down   │  │ <Space>ha   Add file          │  │ <Space>at  Toggle/minimize   │",
    ...
    "",
    "  ┌─ 🖥️  SSH REMOTE ──────────────────────────────────────────────────────────────────────────────┐",
    "  │ <Space>sr  Open SSH host picker (reads ~/.ssh/config)                                         │",
    "  │                                                                                                │",
    "  │ In picker:  Enter   Bootstrap deps + install nvim config + connect                             │",
    "  │             <C-s>   Connect directly (skip bootstrap)                                         │",
    "  │             Select '+ Add new connection' to save a new host to ~/.ssh/config                 │",
    "  │                                                                                                │",
    "  │ Bootstrap:  checks git + neovim, prompts y/n to install each, then clones nvim config         │",
    "  │             on completion drops into an interactive remote shell  (● = session active)        │",
    "  └────────────────────────────────────────────────────────────────────────────────────────────────┘",
    "",
    "",
    "          ═══════════════════════════════════════════════════════════",
