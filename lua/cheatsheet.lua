...
local function lines()
  return {
    ...
    "│ <Space>q   Quit            │  │ <Space>ah  Open chat       │  │ <Space>gm  Git menu        │",
    ...
    "│ <Space>fg  Live grep       │  │ <Space>am  Switch model    │  │ <Space>gr  Reset hunk      │",
    "│ <Space>fb  Buffers         │  │ <Space>ac  Switch Claude   │  │ <Space>go  Open diff       │",  
    "│ <Space>?   Cheat sheet     │  │ <Space>ar  Refresh         │  │ <Space>gf  File history    │",
    "│ <Space>z   Zen mode        │  │ <Space>aB  Add buffers     │  │ ]c/[c      Next/Prev hunk  │",
    "│ <Space>ta  Toggle autosave │  │ <Space>as  Show repo map   │  └────────────────────────────┘",
    "└────────────────────────────┘  │ <Space>aS  Stop request    │",
    "                                └────────────────────────────┘",
    "└────────────────────────────┘",
    "",
